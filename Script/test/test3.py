...
def evaluate_numbers(numbers):
    ...
    print("Number < 50:", len(liste_m_50))
    print("Numbers > 50 and > 0: ", len(liste_p_50))
...
def biased_random_around_zero(bias=0.0, max_value=100):
    ...
    biased_value = value + bias * (1 - abs(value))
...
neg_values = [biased_random_around_zero(-0.8) for _ in range(1000)]
